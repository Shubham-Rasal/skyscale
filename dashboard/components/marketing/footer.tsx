...
export function MarketingFooter() {
  return (
    <footer className="relative border-t border-border/60 bg-background py-12 sm:py-16">
      <div className="pointer-events-none absolute inset-0 bg-galaxy-subtle opacity-30" />
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 sm:px-6 md:flex-row md:items-start md:justify-between">
        <div>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-3 sm:gap-10">
          <div>
      ...
      <div className="relative mx-auto mt-12 max-w-6xl border-t border-border/60 px-4 pt-8 sm:px-6">
